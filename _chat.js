...
(function () {
  ...
  var CHANNELS = [
    ...
    //
    // **ตั้งใจไม่ใช้ m.me/doospend**: มันไม่ redirect (ตอบ 200 เฉยๆ) = แปลงชื่อผู้ใช้เป็น
    ...
    { id: 'messenger', label: 'ทักเพจ Facebook', url: 'https://www.facebook.com/doospend', color: '#0866FF',
